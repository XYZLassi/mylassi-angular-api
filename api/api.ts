...
export const APIS = [APIService, ExercisesService, FilesService, ImagesService, LessonPageElementsService, LessonPageTemplateService, LessonsService, MethodsTwitterService, PollsService];
